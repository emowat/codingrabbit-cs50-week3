...
Inside this repository, you will find several problem set folders for Week 3:
* `sort/` - Analyze compiled programs to determine which sorting algorithm they use.
* `runoff/` - Simulate a ranked-choice instant runoff election. (More comfortable version)
* `tideman/` - Simulate a ranked-choice Tideman election. (Very comfortable version)

**Note on Runoff vs. Tideman:** 
You can choose to do either `runoff` (if feeling more or less comfortable) or `tideman` (if feeling very, very comfortable). Tideman is optional but challenging! If you submit both, we’ll record the higher of your two scores.
...
2. Follow the instructions to download the starter code, create your `.c` files, and begin working!
...
1. `git remote add upstream https://github.com/emowat/codingrabbit-cs50-week3.git` *(one-time setup — links you to the original course repository; skip this if you've already done it once)*
